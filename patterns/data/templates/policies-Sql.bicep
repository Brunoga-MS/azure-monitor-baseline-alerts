...
var loadPolicyDefinitions = {
  All: [
    ...
    loadTextContent('../../../services/Sql/managedInstances/Deploy-SqlMI-AvgCpuPercent-Alert.json')
    loadTextContent('../../../services/Sql/managedInstances/Deploy-SqlMI-StorageSpaceUsageMb-Alert.json')
