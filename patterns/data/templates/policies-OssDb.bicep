...
var loadPolicyDefinitions = {
  All: [
    // Used in OSS DB Policy Set Definitions
    loadTextContent('../../../services/DBforMariaDB/servers/Deploy-MariaDB-CpuPercent-Alert.json')
    loadTextContent('../../../services/DBforMariaDB/servers/Deploy-MariaDB-MemoryPercent-Alert.json')
    loadTextContent('../../../services/DBforMariaDB/servers/Deploy-MariaDB-StoragePercent-Alert.json')
    loadTextContent('../../../services/DBforMariaDB/servers/Deploy-MariaDB-IOConsumption-Alert.json')
